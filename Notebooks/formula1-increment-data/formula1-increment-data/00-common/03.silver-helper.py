...
# DBTITLE 1,Write to silver helper
...
def write_to_silver(
    ...
    Otherwise merge the input DataFrame into the target table.
    """
    final_df = (
        input_df.withColumn("created_timestamp", F.current_timestamp()).withColumn(
    ...
    if not spark.catalog.tableExists(target_table):
        ...
        (
            delta_table.alias("t")
            .merge(final_df.alias("s"), merge_conditions)
            .whenMatchedUpdate(
